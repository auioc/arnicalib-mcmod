...
public interface CommandUtils {
    ...
    TranslatableComponent INTERNAL_ERROR_MESSAGE = TextUtils.I18nText(ArnicaLib.MOD_ID + ".command.failed.internal");

    SimpleCommandExceptionType INTERNAL_ERROR = new SimpleCommandExceptionType(INTERNAL_ERROR_MESSAGE);
    SimpleCommandExceptionType NOT_SERVER_ERROR = new SimpleCommandExceptionType(TextUtils.I18nText(ArnicaLib.MOD_ID + ".command.failed.not_server"));
    SimpleCommandExceptionType NOT_DEDICATED_SERVER_ERROR = new SimpleCommandExceptionType(TextUtils.I18nText(ArnicaLib.MOD_ID + ".command.failed.not_dedicated_server"));
    SimpleCommandExceptionType REFLECTION_ERROR = new SimpleCommandExceptionType(TextUtils.I18nText(ArnicaLib.MOD_ID + ".command.failed.reflection"));
